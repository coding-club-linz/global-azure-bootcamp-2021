...
// convert to png
execSync(`"C:\\Program Files\\Inkscape\\bin\\inkscape" --export-filename "../../static/sessions/cards/outro.png" --export-type "png" "outro.svg"`, (error, stdout, stderr) => {
    console.log('   ', error, stdout, stderr);
});

execSync(`"C:\\Program Files\\Inkscape\\bin\\inkscape" --export-filename "../../static/sessions/cards/battleship.png" --export-type "png" "battleship.svg"`, (error, stdout, stderr) => {
    console.log('   ', error, stdout, stderr);
});
...
for (let session of data.sessions) {
    try {
        ...
        // convert to png
        execSync(`"C:\\Program Files\\Inkscape\\bin\\inkscape" --export-filename "../../static/sessions/cards/${shortTitle}.png" --export-type "png" "svg\\${shortTitle}.svg"`, (error, stdout, stderr) => {
            console.log('   ', error, stdout, stderr);
        });
